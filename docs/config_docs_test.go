...
func TestConfigDocsUpToDate(t *testing.T) {
	...
	assert.Equal(t, configOnDiskHash.Sum(nil), generatedConfigHash.Sum(nil), "The config reference docs generated by the code did not match the docs/reference/config.md file in git. Did you forget to run `make swagger`?")
}
