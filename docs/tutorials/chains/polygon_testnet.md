...
- See the list of Polygon [RPC endpoints](https://wiki.polygon.technology/docs/operate/network-rpc-endpoints/) and select an HTTPS RPC endpoint for `PoS Testnet`.
