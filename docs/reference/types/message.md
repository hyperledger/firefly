...
| `state` | The current state of the message | `staged`<br/>`ready`<br/>`sent`<br/>`pending`<br/>`confirmed`<br/>`rejected` |
...
| `type` | The type of the message | `definition`<br/>`broadcast`<br/>`private`<br/>`groupinit`<br/>`transfer_broadcast`<br/>`transfer_private` |
| `txtype` | The type of transaction used to order/deliver this message |  |
