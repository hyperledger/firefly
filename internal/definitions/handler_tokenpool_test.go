...
func TestHandleDefinitionBroadcastTokenPoolExistingUnpublished(t *testing.T) {
	sh, bs := newTestDefinitionHandler(t)
...
func TestHandleDefinitionBroadcastTokenPoolExistingUnpublishedError(t *testing.T) {
	sh, bs := newTestDefinitionHandler(t)
