...
var (
	...
	MsgDBMissingJoin           = ffm("FF10118", "Database missing expected join entry in table '%s' for id '%s'")
	MsgDBReadErr               = ffm("FF10119", "Database resultset read error from table '%s'")
	MsgUnknownDatabasePlugin   = ffm("FF10120", "Unknown database plugin: %s")
)
