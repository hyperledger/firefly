...
var (
	...
	MsgGoTemplateCompileFailed      = ffm("FF10335", "Go template compilation for '%s' failed: %s", 500)
	MsgGoTemplateExecuteFailed      = ffm("FF10336", "Go template execution for '%s' failed: %s", 500)
	MsgAddressResolveFailed         = ffm("FF10337", "Failed to resolve signing key string '%s': %s", 500)
	MsgAddressResolveBadStatus      = ffm("FF10338", "Failed to resolve signing key string '%s' [%d]: %s", 500)
	MsgAddressResolveBadResData     = ffm("FF10339", "Failed to resolve signing key string '%s' - invalid address returned '%s': %s", 500)
)
