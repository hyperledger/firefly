...
var (
	...
	MsgFFIValidationFail            = ffm("FF10330", "Field '%s' does not validate against the provided schema", 400)
	MsgFFISchemaParseFail           = ffm("FF10331", "Failed to parse schema for param '%s'", 400)
	MsgFFISchemaCompileFail         = ffm("FF10332", "Failed compile schema for param '%s'", 400)
	MsgPluginInitializationFailed   = ffm("FF10333", "Plugin initialization error", 500)
)
