...
var (
	...
	MsgNodeAndOrgIDMustBeSet       = ffm("FF10216", "Organization name and identity must be configured first", 409)
	...
	MsgGroupMustHaveRecipients     = ffm("FF10219", "Group must have at least one recipient", 400)
	MsgEmptyRecipientOrg           = ffm("FF10220", "Org is blank in recipient %d")
	MsgEmptyRecipientNode          = ffm("FF10221", "Node is blank in recipient %d")
