...
var (
	...
	MsgMetricCollectionParam       = ffm("FF10297", "Collection to fetch")
	MsgInvalidNumberOfIntervals    = ffm("FF10298", "Number of time intervals must be between %d and %d")
	MsgInvalidMetricParam          = ffm("FF10299", "Invalid %s. Must be a number.", 400)
	MsgErrorFetchingRows           = ffm("FF10300", "Error fetching rows from table")
	MsgInvalidSQLQuery             = ffm("FF10301", "Invalid SQL query")
)
