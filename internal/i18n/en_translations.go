...
var (
	...
	MsgContractInterfaceExists     = ffm("FF10293", "A contract interface already exists in the namespace: '%s' with name: '%s' and version: '%s'")
	MsgContractInterfaceNotFound   = ffm("FF10294", "Contract interface %s not found")
