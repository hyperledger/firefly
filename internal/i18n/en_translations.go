...
var (
	...
	MsgContractMethodNotSet         = ffm("FF10304", "Method not specified on invoke contract request", 400)
	MsgContractNoMethodSignature    = ffm("FF10305", "Method signature is required if contractId is absent", 400)
	MsgContractResolveError         = ffm("FF10306", "Unable to resolve contract method", 400)
	MsgContractAPIExists            = ffm("FF10307", "A contract API already exists in the namespace: '%s' with name: '%s'", 409)
)
