...
func (bc *boundCallbacks) BlockchainOperatorAction(action string, event *blockchain.Event, signingKey *core.VerifierRef) error {
	return bc.ei.BlockchainOperatorAction(bc.bi, action, event, signingKey)
}
