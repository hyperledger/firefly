...
// 	mim.On("GetNodeOwnerOrg", pm.ctx).Return(&fftypes.Organization{Identity: signingKeyLocal}, nil)
...
// 	mim.On("GetNodeOwnerOrg", pm.ctx).Return(&fftypes.Organization{Identity: "localorg"}, nil)
