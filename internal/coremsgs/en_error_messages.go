...
var (
	...
	MsgMissingTokensConfig          = ffe("FF10386", "Invalid tokens configuration - name and type are required")
	MsgMissingBlockchainConfig      = ffe("FF10387", "Invalid blockchain configuration - name and type are required")
	MsgMissingDatabaseConfig        = ffe("FF10388", "Invalid database configuration - name and type are required")
	MsgMissingSharedStorageConfig   = ffe("FF10389", "Invalid shared storage configuration - name and type are required")
	MsgMissingDataExchangeConfig    = ffe("FF10390", "Invalid data exchange configuration - name and type are required")
	MsgMissingIdentityPluginConfig  = ffe("FF10391", "Invalid identity plugin configuration - name and type are required")
)
