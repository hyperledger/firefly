...
var (
	...
	ContractListenerFilterHash = ffm("ContractListener.filterHash", "This is the hash of the filters provided, useful to be able to retrieve a unique contract listener.")
