...
var (
	...
	TokenApprovalSubject         = ffm("TokenApproval.subject", "A unique identifier for this approval, as provided by the token connector")
	...
	TokenPoolProtocolID = ffm("TokenPool.protocolId", "A unique identifier for the pool, as provided by the token connector")
	...
	TokenTransferSubject         = ffm("TokenTransfer.subject", "A unique identifier for this transfer, as provided by the token connector")
