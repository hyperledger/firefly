...
var (
	...
	APIEndpointsGetStatusPins                   = ffm("api.endpoints.getStatusPins", "Gets the status of the pins worker")
	...
	APIEndpointsPostNewSubscription             = ffm("api.endpoints.postNewSubscription", "Create a new subscription for an application to receive events from FireFly")
	APIEndpointsPostOpRetry                     = ffm("api.endpoints.postOpRetry", "Retry a failed operation")
	APIEndpointsPostTokenApproval               = ffm("api.endpoints.postTokenApproval", "Create a token approval")
	APIEndpointsPostTokenBurn                   = ffm("api.endpoints.postTokenBurn", "Burn some tokens")
	APIEndpointsPostTokenMint                   = ffm("api.endpoints.postTokenMint", "Mint some tokens")
	APIEndpointsPostTokenPool                   = ffm("api.endpoints.postTokenPool", "Create a new token pool")
	APIEndpointsPostTokenTransfer               = ffm("api.endpoints.postTokenTransfer", "Transfer some tokens")
	APIEndpointsPutContractAPI                  = ffm("api.endpoints.putContractAPI", "Update an existing contract API")
