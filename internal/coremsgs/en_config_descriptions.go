...
var (
	...
	ConfigPluginBlockchainEthereumEthconnectBackgroundStart = ffc("config.plugins.blockchain[].ethereum.ethconnect.backgroundStart", "Start the Ethconnect plugin in the background and enter retry loop if failed to start", i18n.BooleanType)
	...
	ConfigPluginBlockchainFabricFabconnectBackgroundStart = ffc("config.plugins.blockchain[].fabric.fabconnect.backgroundStart", "Start the fabconnect plugin in the background and enter retry loop if failed to start", i18n.BooleanType)
