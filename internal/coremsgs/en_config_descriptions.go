...
var (
	...
	ConfigCacheTransactionLimit        = ffc("config.cache.transaction.limit", "Max number of cached transactions", i18n.IntType)
	...
	ConfigCacheMessageLimit            = ffc("config.cache.message.limit", "Max number of cached messages for data manager", i18n.IntType)
	ConfigCacheMessageTTL              = ffc("config.cache.message.ttl", "Time to live of cached messages for data manager", i18n.StringType)
	ConfigCacheValidatorLimit          = ffc("config.cache.validator.limit", "Max number of cached validators for data manager", i18n.IntType)
