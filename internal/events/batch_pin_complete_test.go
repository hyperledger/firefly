...
func TestPersistBatchDataWithPublicAlreaydDownloadedOk(t *testing.T) {
	...
	em.mdi.On("GetBlob", mock.Anything, mock.Anything, mock.Anything, blob.Hash).Return(blob, nil)
...
func TestPersistBatchDataWithPublicInitiateDownload(t *testing.T) {
	...
	em.mdi.On("GetBlob", mock.Anything, mock.Anything, mock.Anything, blob.Hash).Return(nil, nil)
...
func TestPersistBatchDataWithBlobGetBlobFail(t *testing.T) {
	...
	em.mdi.On("GetBlob", mock.Anything, mock.Anything, mock.Anything, blob.Hash).Return(nil, fmt.Errorf("pop"))
