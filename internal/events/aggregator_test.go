...
func TestAttemptMessageDispatchMissingBlobs(t *testing.T) {
	...
	ag.mdi.On("GetBlobMatchingHash", ag.ctx, blobHash, mock.Anything).Return(nil, nil)
...
func TestDispatchPrivateQueuesLaterDispatch(t *testing.T) {
	...
	ag.mdi.On("GetBlobMatchingHash", ag.ctx, data2[0].Blob.Hash, mock.Anything).Return(nil, nil)
...
func TestResolveBlobsErrorGettingHash(t *testing.T) {
	...
	ag.mdi.On("GetBlobMatchingHash", ag.ctx, mock.Anything, mock.Anything).Return(nil, fmt.Errorf("pop"))
...
func TestResolveBlobsNotFoundPrivate(t *testing.T) {
	...
	ag.mdi.On("GetBlobMatchingHash", ag.ctx, mock.Anything, mock.Anything).Return(nil, nil)
...
func TestResolveBlobsFoundPrivate(t *testing.T) {
	...
	ag.mdi.On("GetBlobMatchingHash", ag.ctx, mock.Anything, mock.Anything).Return(&core.Blob{}, nil)
