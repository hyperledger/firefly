...
func TestGetIdentities(t *testing.T) {
	...
	mnm.On("GetIdentities", mock.Anything, "ns1", mock.Anything).Return([]*fftypes.Identity{}, nil, nil)
	r.ServeHTTP(res, req)
...
func TestGetIdentitiesWithVerifiers(t *testing.T) {
	...
	mnm.On("GetIdentitiesWithVerifiers", mock.Anything, "ns1", mock.Anything).Return([]*fftypes.IdentityWithVerifiers{}, nil, nil)
	r.ServeHTTP(res, req)
