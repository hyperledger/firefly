...
func TestPostTokenTransferByType(t *testing.T) {
	...
	mam.On("TransferTokensByType", mock.Anything, "ns1", "tok1", "pool1", mock.AnythingOfType("*fftypes.TokenTransferInput"), false).
