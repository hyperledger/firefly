...
var postInvokeContractInterface = &oapispec.Route{
	Name:   "postContractInvokeInterface",
	Path:   "namespaces/{ns}/contracts/interfaces/{contractID}/invoke/{methodName}",
