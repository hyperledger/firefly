...
type Plugin interface {
	...
	// GetContractListenerStatus gets the status of a contract listener from the backend connector
	GetContractListenerStatus(ctx context.Context, subID string, okNotFound bool) (interface{}, error)
