...
type Plugin interface {
	...
	InvokeContract(ctx context.Context, operationID *fftypes.UUID, signingKey string, onChainLocation fftypes.OnChainLocation, method *fftypes.FFIMethod, params map[string]interface{}) (interface{}, error)

	ValidateOnChainLocation(ctx context.Context, onChainLocation fftypes.OnChainLocation) error
}
