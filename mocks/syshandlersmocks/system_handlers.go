...
import (
	...
	syshandlers "github.com/hyperledger/firefly/internal/syshandlers"
)
...
func (_m *SystemHandlers) HandleSystemBroadcast(ctx context.Context, msg *fftypes.Message, data []*fftypes.Data) (syshandlers.SystemBroadcastAction, error) {
	ret := _m.Called(ctx, msg, data)

	var r0 syshandlers.SystemBroadcastAction
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.Message, []*fftypes.Data) syshandlers.SystemBroadcastAction); ok {
		r0 = rf(ctx, msg, data)
	} else {
		r0 = ret.Get(0).(syshandlers.SystemBroadcastAction)
	}
