...
func (_m *Engine) GetBatches(ctx context.Context, ns string, filter database.AndFilter) ([]*fftypes.Batch, error) {
...
func (_m *Engine) GetData(ctx context.Context, ns string, filter database.AndFilter) ([]*fftypes.Data, error) {
	ret := _m.Called(ctx, ns, filter)
...
func (_m *Engine) GetDataDefinitions(ctx context.Context, ns string, filter database.AndFilter) ([]*fftypes.DataDefinition, error) {
	ret := _m.Called(ctx, ns, filter)
...
func (_m *Engine) GetTransactions(ctx context.Context, ns string, filter database.AndFilter) ([]*fftypes.Transaction, error) {
	ret := _m.Called(ctx, ns, filter)
