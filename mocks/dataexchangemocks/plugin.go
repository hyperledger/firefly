...
// CheckNodeIdentityStatus provides a mock function with given fields: ctx, dxPeer, node
func (_m *Plugin) CheckNodeIdentityStatus(ctx context.Context, dxPeer fftypes.JSONObject, node *core.Identity) error {
	ret := _m.Called(ctx, dxPeer, node)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, fftypes.JSONObject, *core.Identity) error); ok {
		r0 = rf(ctx, dxPeer, node)
	} else {
		r0 = ret.Error(0)
	}
